...
const recursionPattern = (int1, int2) => {
    ...
    let arr = [];
    recursionPattern0(int1,int2);
    function recursionPattern0(int1,int2){
...
const isPalindrome = (str) => {
    ...
    let reversStr = lowRegx.split('').reverse().join('');
    return reversStr === lowRegx;
}
// -------------------------------------------------------------------------------------------------------
