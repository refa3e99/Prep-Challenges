...
const objLat = (obj) => {
    ...
    let info = "my name is " + capitalizeFirstLetter(firstName) +" "+ capitalizeFirstLetter(lastName) +" I am "+age+" YO, and I love "+hobby+"."
    return info
};
// -------------------------------------------------------------------------------------------------------
    ...
    for(let i=0;i<=arr.length-1;i++){
        if(arr[i].yearsOfExperience>1){
            ...
            { obj = {fullName : arr[i].firstName,tech : arr[i].tech}}
              ...
              obj = {fullName : arr[i].lastName,tech : arr[i].tech}
            }
            else {
