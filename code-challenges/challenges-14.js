...
const LastWord = (str) => {
    ...
    lastWord = str.slice((str.lastIndexOf(" ")+1),str.length);
...
const replaceWords = (str) => {
    ...
    if (word.includes("I")==true) {
        word.splice(word.indexOf("I"),1,"We");
    }
    if (word.includes("am")==true) {
        word.splice(word.indexOf("am"),1,"are");
    }
    if (word.includes("was")==true) {
        word.splice(word.indexOf("was"),1,"were");
    }
